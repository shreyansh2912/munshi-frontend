      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
         <Card className="p-4 flex items-center gap-4">
            ...
            <div>
               ...
               <h3 className="text-xl font-bold dark:text-white">₹4,50,000</h3>
            </div>
         </Card>
         <Card className="p-4 flex items-center gap-4">
            ...
            <div>
               ...
               <h3 className="text-xl font-bold dark:text-white">₹2,50,000</h3>
            </div>
         </Card>
         <Card className="p-4 flex items-center gap-4">
            ...
            <div>
               ...
               <h3 className="text-xl font-bold dark:text-white">₹1,25,000</h3>
            </div>
         </Card>
      </div>
