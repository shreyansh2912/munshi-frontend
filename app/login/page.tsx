...
import { Sparkles, ArrowRight, Lock, Mail, ArrowLeft, RefreshCw } from 'lucide-react';
        ...
        <div className="w-full max-w-md">
           ...
           <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="flex justify-end">
                 <a href="#" className="text-sm font-medium text-munshi-teal hover:text-munshi-indigo dark:text-teal-400 dark:hover:text-teal-300">Forgot password?</a>
              </div>
