/**
 * Customers Scene (Client Component)
 * Handles customers UI and interactions
 */
...
interface CustomersSceneProps {
  initialData: {
    customers: Customer[];
  };
}

export default function CustomersScene({ initialData }: CustomersSceneProps) {
